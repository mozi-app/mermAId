...
const darkTheme = EditorView.theme({
    ...
    '.cm-content': { color: '#ddd6fe', caretColor: '#a78bfa' },
    ...
    '.cm-activeLineGutter': { backgroundColor: '#1e1b4b', color: '#c4b5fd' },
    '.cm-activeLine': { backgroundColor: 'rgba(99, 102, 241, 0.16)' },
});

const darkHighlightStyle = HighlightStyle.define([
    { tag: tags.keyword, color: '#c4b5fd' },
    { tag: [tags.name, tags.deleted, tags.character, tags.propertyName], color: '#ddd6fe' },
    ...
    { tag: [tags.definition(tags.name), tags.separator], color: '#a5b4fc' },
    { tag: [tags.className], color: '#e0e7ff' },
    { tag: [tags.number, tags.changed, tags.annotation, tags.modifier], color: '#7dd3fc' },
    { tag: [tags.typeName], color: '#818cf8' },
    { tag: [tags.operator, tags.operatorKeyword], color: '#ddd6fe' },
    { tag: [tags.url, tags.escape, tags.regexp, tags.link], color: '#60a5fa' },
    { tag: [tags.meta, tags.comment], color: '#94a3b8' },
    { tag: tags.strong, fontWeight: '700' },
    { tag: tags.emphasis, fontStyle: 'italic' },
    { tag: tags.strikethrough, textDecoration: 'line-through' },
    { tag: tags.heading, color: '#c4b5fd', fontWeight: '700' },
    { tag: [tags.atom, tags.bool, tags.special(tags.variableName)], color: '#67e8f9' },
    { tag: [tags.processingInstruction, tags.string, tags.inserted], color: '#bfdbfe' },
